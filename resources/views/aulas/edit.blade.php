...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h1 style="margin: 0; color: #333;">Editar Aula</h1>
    <div style="display: flex; gap: 10px;">
        <a href="{{ route('aulas.show', $aula) }}" style="background: #17a2b8; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: 500;">
            Ver Aula
        </a>
    ...
    <form method="POST" action="{{ route('aulas.update', $aula) }}">
        ...
        <div style="margin-bottom: 30px;">
            ...
            <textarea id="ubicacion" 
                      ...
                      placeholder="Ej: Edificio A, Primer Piso, Ala Norte">{{ old('ubicacion', $aula->ubicacion) }}</textarea>
