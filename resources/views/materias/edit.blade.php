...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h1 style="margin: 0; color: #333;">Editar Materia</h1>
    <div style="display: flex; gap: 10px;">
        <a href="{{ route('materias.show', $materia) }}" style="background: #17a2b8; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: 500;">
            Ver Materia
        </a>
